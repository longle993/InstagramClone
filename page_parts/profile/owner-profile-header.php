...
<div class="flex-space" id="owner-profile-menu-and-profile-edit">
    <div class="row-v-flex">
        <a href="" class="button-style-3" id="edit-profile-button">Edit profile</a>
        <div class="viewer">
                ...
                <div id="edit-sub-container">
                    ...
                    <div id="textual-data-edit">
                        ...
                        <div class="field-style-1">
                            ...
                            <textarea type="text" form="save-profile-edits-form" maxlength="800" class="textarea-style-1" placeholder="Add bio..." name="bio"><?php echo $fetched_user->getPropertyValue('bio'); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
