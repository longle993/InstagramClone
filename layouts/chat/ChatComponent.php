...
use models\{User, Message};
    class ChatComponent {
        public static function generate_chat_page_friend_contact($current_user_id, $user) {
            ...
            $user_picture = Config::get("root/path") . (empty($user->getPropertyValue("picture")) ? "public/assets/images/logos/Profile.jpg" : $user->getPropertyValue("picture"));
        ...
        public static function generate_chat_section($sender, $receiver) {
            ...
            $friend_picture = empty($rcv->getPropertyValue("picture")) ? "public/assets/images/logos/Profile.jpg" : $rcv->getPropertyValue("picture");
            ...
            echo <<<CHAT_SECTION
                <div id="second-chat-part" class="relative">
                    ...
                    <div id="chat-container" class="relative">
                        <div class="chat-date">
                            <p class="regular-text" style="text-align: center; margin: 14px 0 20px 0">DEC 11, 2023 8:30 AM</p>
                        </div>
                    </div>
                    <div class="message-input-box relative">
                        ...
                        <input type="text" form="send-message-form" placeholder="Message..." id="chat-text-input" class="chat-input-style send-button" style="padding-left: 15px">
                ...
                <div class="message-global-container">
                    <div class="current-user-message-container">
                        <div class="relative">
                            ...
                            <div class="sub-options-container sub-options-container-style-2" style="z-index: 1; width: 129px; left: -98px; top: -10px">
                                <div class="options-container-style-1 black">
                                    <div class="sub-option-style-2">
                        ...
                        <div class="message-wrapper relative" style="background-color: rgb(14, 143, 242);">
                ...
                <div class="message-global-container">
                    <div class="friend-message-container">
                        ...
                        <div class="relative">
                            ...
                            <div class="sub-options-container sub-options-container-style-2" style="z-index: 1; width: 129px; left: -6px; top: -10px">
                                <div class="options-container-style-1 black">
                                    <div class="sub-option-style-2">
                                        <a href="" class="black-link delete-current-user-message">Delete message</a>
                                        <input type="hidden" value="$message_id" class="message_id">
        ...
        public static function generate_sender_reply_message($original_message_id, $reply_message_id, $original_message_creator_id, $reply_creator_id) {   
            ...
            $reply_message_picture = Config::get("root/path") . (empty($reply_message_owner->getPropertyValue("picture")) ? "public/assets/images/logos/Profile.jpg" : $reply_message_owner->getPropertyValue("picture"));
            return <<<FM
        ...
        public static function generate_discussion($current_user_id, $discussion) {
            ...
            $friend_picture = Config::get("root/path") . (empty($friend_user->getPropertyValue("picture")) ? 'public/assets/images/logos/Profile.jpg' : $friend_user->getPropertyValue("picture"));
