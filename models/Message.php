...
class Message {
    ...
    public function add() {
        $this->db->query("INSERT INTO `message` (`message_creator`, `message`, `create_date`, `is_reply`, `reply_to`) VALUES (?, ?, ?, ?, ?)", array(
            $this->message_sender,
            $this->message,
            $this->message_date,
            $this->is_reply,
        ...
        $this->db->query("INSERT INTO `channel` (`sender`, `receiver`, `group_recipient_id`, `message_id`) VALUES (?, ?, ?, ?)", array(
            $this->message_sender,
        ...
        $this->db->query("INSERT INTO `message_recipient` (`receiver_id`, `message_id`, `is_read`) VALUES (?, ?, ?)", array(
            $this->message_receiver,
            $last_inserted_message_id,
            $this->is_read
        ));
